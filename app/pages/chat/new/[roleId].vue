...
<template>
  <div class="h-screen w-full bg-primary-50/50 flex items-center justify-center max-w-md mx-auto">
    <!-- Loading state -->
    <div v-if="isLoading" class="flex flex-col items-center space-y-4 text-primary">
      <Icon name="material-symbols:refresh" class="text-6xl animate-spin" />
      <span>正在创建新对话...</span>
    </div>

    <!-- Error state -->
    <div v-else-if="error" class="flex flex-col items-center space-y-4 text-primary">
